...
function displayFeeds(items){
    for(var i=0;i<items.length;i++){
		var value = "<li onclick='getID(this)'><a href='#myPopup1' data-rel='popup' data-position-to='window' data-transition='flip'><img src='./images/student.png'><h3 style='color: #00897B;' >"+items[i].name+"</h3><p><b><i>"+items[i].adress+"</b></i></p><span style='color:red;' class='ui-li-count'>"+items[i].id+"</span></a><a href='#delStudent' data-rel='popup' data-position-to='window' data-transition='pop'></a></li>";
...
function displayCus(items){
    for(var i=0;i<items.length;i++){
		var value = "<li onclick='getIDCus(this)'><a href='#updateCus' data-rel='popup' data-position-to='window' data-transition='flip'><img src='./images/student.png'><h3 style='color: #00897B;' >"+items[i].cusname+"</h3><p><b><i>"+items[i].cusphone+"</b></i></p><span style='color:red;' class='ui-li-count'>"+items[i].cusid+"</span></a><a href='#delCustomer' data-rel='popup' data-position-to='window' data-transition='pop'></a></li>";
